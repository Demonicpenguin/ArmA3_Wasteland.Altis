...
_setupObjects = {
	...
	_missionHintText = format ["<br/>Stop the Assassins in<br/><t size='1.35' color='%1'>%2</t><br/><br/>one of 'em holds 2<br/><t color='%1'>files wich are worth %3</t><br/>at the exchangedevice.", infantryMissionColor, _townName, _moneyText];
};
