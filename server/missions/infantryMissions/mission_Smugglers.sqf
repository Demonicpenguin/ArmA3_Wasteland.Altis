...
_setupObjects =
{
	...
	_missionHintText = format ["<br/>Smugglers await the arrival of paramilitary units. Intercept this deal!", infantryMissionColor];
};
...
_successExec =
{
	...
	_cashamountrandomizera = [20000,30000,40000,50000,60000,70000];
	...
	_cashamountrandomizerb = [20000,30000,40000,50000,60000,70000];
