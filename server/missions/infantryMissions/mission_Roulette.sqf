...
private ["_positions", "_camonet", "_hostage", "_hostage2", "_vehicleName", "_randomBox", "_randomCase", "_box1", "_para", "_geoPos", "_radSource"];
...
_setupObjects =
{
    ...
    _missionHintText = format ["<br/>Two aspirants of <t color='%2'>Altis Gendarmerie</t> set two civilians captive to play justice.<br/> Head there, show them the brutality of real justice:<br/>kill them and <t color='%2'>execute ONLY the guilty civilian</t>!", _vehicleName, infantryMissionColor];
};
