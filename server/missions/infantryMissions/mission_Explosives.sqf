...
_setupObjects =
{
	...
	_missionHintText = format ["<br/>Criminal merchants try to sell nearly everything! Today's offer:<br/><t color='%1'>improvised explosive devices</t>.<br/>Eliminate these jerks and save the IED - for your own interests!", infantryMissionColor];
