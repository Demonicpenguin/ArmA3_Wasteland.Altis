...
private ["_positions", "_camonet", "_laptop", "_obj1", "_obj2", "_obj3", "_obj4", "_box1", "_box2", "_box3", "_box4"];

_setupVars =
{
	_missionType = "Sam Site";
...
_setupObjects =
{
	...
	_obj1 = createVehicle ["B_SAM_System_02_F", _missionPos,[], 10,"None"]; 
	_obj1 setPosATL [(_missionPos select 0) - 20, (_missionPos select 1) + 20, _missionPos select 2];
	...
	_obj2 setPosATL [(_missionPos select 0) + 20, (_missionPos select 1) + 20, _missionPos select 2];
	...
	_obj3 = createVehicle ["B_AAA_System_01_F", _missionPos,[], 10,"None"]; 
	_obj3 setPosATL [(_missionPos select 0) - 20, (_missionPos select 1) - 20, _missionPos select 2];
	...
	_obj4 = createVehicle ["B_SAM_System_01_F", _missionPos,[], 10,"None"]; 
	_obj4 setPosATL [(_missionPos select 0) + 20, (_missionPos select 1) - 20, _missionPos select 2];
	...
	{ _x setVariable ["R3F_LOG_disabled", true, true] } forEach [_obj1, _obj2, _obj3, _obj4];	
	...
	_missionPicture = "media\samsite.paa";
	//_vehicleName = getText (configFile >> "CfgVehicles" >> _vehicleClass >> "displayName");	
	
	_missionHintText = format ["<br/>A Sam site protected by a patrol of soldiers are operating in the area. The Skies are no longer safe.<br/>Go there, Destroy the Missle site and make the skies safe.", infantryMissionColor];	
...
_failedExec =
{
	...
	{ deleteVehicle _x } forEach [_camonet, _obj1, _obj2, _obj3, _obj4];
...
_successExec =
{
	...
	_successHintMessage = "The Samsite has been destroyed and the soldiers have been eliminated, the money, crates and vehicles are yours to take.";
};
