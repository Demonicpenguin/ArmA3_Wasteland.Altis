/*
	...
	Description:
	Place this file at \server\missions\moneyMissions\mission_HackATM.sqf
...
_setupObjects =
{
	...
	_missionPicture = "media\laptop.jpg";
	_missionHintText = format ["The enemy are attempting to <t color='%1'>hack an ATM</t> remotely, go eradicate the enemy, steal the laptop and go hack an ATM for yourself!",premiumMissionColor];
};
...
{
	{
		...
		if ((typeOf _x) isEqualTo "Land_Laptop_unfolded_F") then
		{
			_x setVariable ["mf_item_id","laptopkl",true]; // allow the laptopkl to be picked up.
		};
	} forEach _objects;
	[_locationsArray, _missionLocation, _objects] call setLocationObjects;
	_successHintMessage = "The enemy have been eradicated... quick, go steal the laptop for yourself and get out of there!";
};
