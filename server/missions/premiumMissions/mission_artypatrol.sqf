...
private ["_convoyVeh","_veh1","_veh2","_veh3","_veh4","_veh5","_veh6","_veh7","_veh8","_veh9","_veh10","_createVehicle1","_createVehicle2","_createVehicle3","_vehicles", "_leader", "_speedMode", "_waypoint", "_vehicleName", "_numWaypoints", "_cash", "_box1", "_box2", "_box3", "_box4", "_box5", "_box6", "_randomBox1", "_randomBox2", "_randomBox3", "_Case1", "_Case2", "_Case3"];
...
_setupObjects =
{
	...
	[
		//NATO Patrols
		["B_APC_Wheeled_01_cannon_F", "B_Heli_Attack_01_F", "B_MBT_01_TUSK_F", "B_APC_Tracked_01_AA_F", "B_Heli_Light_01_armed_F", "B_MBT_01_mlrs_F", "B_APC_Tracked_01_AA_F"], // Light Patrol


		//CSAT Patrols
		["O_APC_Wheeled_02_rcws_F", "O_Heli_Attack_02_F", "O_MBT_02_cannon_F", "O_APC_Tracked_02_AA_F", "O_Heli_Light_02_F", "B_MBT_01_arty_F", "O_APC_Tracked_02_AA_F"],

		//AAF Patrols
		["I_APC_Wheeled_03_cannon_F", "B_Heli_Attack_01_F", "I_MBT_03_cannon_F", "O_APC_Tracked_02_AA_F", "I_Heli_light_03_F", "B_MBT_01_arty_F", "O_APC_Tracked_02_AA_F"]
	...
	_vehicleName3 = getText (configFile >> "CfgVehicles" >> _veh7 >> "displayName");

	_missionHintText = format ["A convoy containing at least a <t color='%4'>%1</t>, a <t color='%4'>%2</t> and a <t color='%4'>%3</t> is patrolling a high value location! Stop the partol and collect the high value weapons crate and money!", _vehicleName, _vehicleName2, _vehicleName3, premiumMissionColor];
...
//Money
	...
	_successHintMessage = "The Artillery patrol has been stopped, the money, crates and vehicles are yours to take.";
};
