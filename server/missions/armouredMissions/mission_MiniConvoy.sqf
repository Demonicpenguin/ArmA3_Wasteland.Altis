...
_setupObjects =
{
	...
	_missionHintText = format ["<br/>A <t color='%2'>%1</t> transporting 2 weapon crates is being escorted by 2 Hunters. <br/>Stop them and get their cargo!", _vehicleName, armouredMissionColor];
