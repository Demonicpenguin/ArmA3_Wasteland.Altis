...
_setupObjects =
{
	...
	_convoyVeh = ["B_AFV_Wheeled_01_cannon_F","B_Heli_Attack_01_F","I_APC_tracked_03_cannon_F","B_Truck_01_covered_F","B_APC_Tracked_01_AA_F"];
	...
	_missionHintText = format ["A HEMTT Transport is on the way, heavily guarded by a Blackfoot and several armed vehicles.<br/>Head there, destroy them all and save their cargo!",  armouredMissionColor];
