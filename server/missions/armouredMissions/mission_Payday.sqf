...
_setupVars =
{
	...
	[
		...
		[
			...
			[
				[ // NATO convoy
					["O_T_MBT_04_command_F"], // Veh 1
					["O_APC_Tracked_02_AA_F"] // Veh 2
				],
				[ // CSAT convoy
					["O_T_MBT_04_command_F"], // Veh 1
					["B_APC_Tracked_01_AA_F"] // Veh 2
				],
				[ // AAF convoy
					["O_T_MBT_04_command_F"], // Veh 1
					["B_APC_Tracked_01_AA_F"] // Veh 2
		...
		[
			...
			[
				[ // NATO convoy
					["B_APC_Tracked_01_AA_F"], // Veh 1
					["C_Truck_02_covered_F"], // Veh 2
					["B_APC_Tracked_01_AA_F"] // Veh 3
				],
				[ // CSAT convoy
					["O_MBT_02_cannon_F"], // Veh 1
					["C_Truck_02_covered_F"], // Veh 2
					["O_MBT_02_cannon_F"] // Veh 3
				],
				[ // AAF convoy
					["O_T_MBT_04_cannon_F"], // Veh 1
					["C_Truck_02_covered_F"], // Veh 2
					["O_T_MBT_04_cannon_F"] // Veh 3
				]
			]
		],
		// Hard
		...
		[
			...
			[
				[ // NATO convoy
					...
					["O_MBT_02_cannon_F"], // Veh 3
					["B_AFV_Wheeled_01_up_cannon_F"] // Veh 4
				],
				[ // CSAT convoy
					["O_APC_Tracked_02_AA_F"], // Veh 1
					["C_Truck_02_box_F"], // Veh 2
...
_setupObjects =
{
	...
	_missionHintText = format ["A <t color='%1'>%3</t> is on the way to support nearby paramilitary outposts.<br/> Rumors say, they also transporting soldiers' earnings for this week: <t color='%1'>%2</t>! <br/>Stop this convoy and let their families eat shit this month!", armouredMissionColor, _moneyText, _vehicleName];
