...
private ["_mechPatrol", "_moneyAmount", "_convoys", "_vehChoices", "_moneyText", "_vehClasses", "_createVehicle", "_vehicles", "_veh2", "_leader", "_speedMode", "_waypoint", "_vehicleName", "_numWaypoints", "_cash", "_boxes1","_boxes2", "_boxes3", "_boxes4", "_boxes5", "_box1", "_box2", "_box3", "_box4", "_box5", "_box6"];
...
//*************************************************************
	...
	_missionHintText = format ["A mechanized convoy transporting supplies and <t color='%3'>%1</t> escorted by a <t color='%3'>%2</t> is patrolling a section of the island.<br/>Stop them!", _moneyText, _vehicleName, armouredMissionColor];
