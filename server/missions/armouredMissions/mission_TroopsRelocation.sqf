...
_setupObjects =
{
	...
	_missionHintText = format ["Several armed units are one the way to <t color='%1'>relocate their new headquarter</t>, using a <t color='%1'>%2</t> and other armed vehicles. <br/>Intercept this convoy, loot the cargo and get their money!", armouredMissionColor, _vehicleName];
