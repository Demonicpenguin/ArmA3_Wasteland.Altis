...
private ["_planeChoices", "_convoyVeh", "_veh1", "_createVehicle", "_vehicles", "_leader", "_speedMode", "_waypoint", "_vehicleName", "_numWaypoints", "_cash", "_boxes1", "_currBox1", "_boxes2", "_currBox2", "_box1", "_box2", "_smokemarker"];
...
_setupObjects =
{
	...
	_missionHintText = format ["A <t color='%2'>%1</t> has been spotted! Time to die, scumbags!", _vehicleName, airborneMissionColor];
