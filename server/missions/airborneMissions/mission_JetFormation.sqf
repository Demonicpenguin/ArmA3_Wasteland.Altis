...
_setupObjects =
{
	...
	_missionHintText = format ["Why so serious? There are only two <t color='%3'>%1</t> in the sky. Valar morgulis - every man must die. You are the next!", _vehicleName, _vehicleName2, airborneMissionColor];
