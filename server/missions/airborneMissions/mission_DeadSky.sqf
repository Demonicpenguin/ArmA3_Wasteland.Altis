...
_setupObjects =
{
	...
	_missionHintText = format ["Two <t color='%3'>%1</t> have been spotted! <br/>Bring them down and take their cargo!", _vehicleName, _vehicleName2, airborneMissionColor];
...
_successExec =
{
	...
	[_smokemarker] spawn CrateFlare; //Calls repeating green smoke grenade
	uiSleep 2;		
