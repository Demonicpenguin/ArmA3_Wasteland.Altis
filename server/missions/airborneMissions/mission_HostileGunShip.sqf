...
_setupObjects =
{
	...
	{
		["O_T_VTOL_02_infantry_F","B_T_VTOL_01_armed_F"] call BIS_fnc_selectRandom;
	}
	else
	{
		["O_T_VTOL_02_infantry_F","B_T_VTOL_01_armed_F"] call BIS_fnc_selectRandom;
	...
	_missionHintText = format ["An armed <t color='%2'>%1</t> is circling the island. It will attack any moving vehicles ! Take it down!", _vehicleName, airborneMissionColor];
...
_successExec =
{
	...
	_vehicle spawn
	{
		...
		[_box2, _randomBox] call randomCrateLoadOut;
		
		//Smoke to mark the crates
		_smokemarker = createMarker ["SMMarker1", getPosATL _veh];
