...
private ["_heliChoices", "_convoyVeh", "_veh1", "_veh2", "_veh3", "_createVehicle", "_vehicles", "_leader", "_speedMode", "_waypoint", "_vehicleName", "_numWaypoints", "_box1", "_box2", "_box3", "_smokemarker"];
...
_setupObjects =
{
	...
	_heliChoices =
	[
		["B_Heli_Light_01_armed_F", "B_Heli_Light_01_dynamicLoadout_F"],
		["B_Heli_Light_01_armed_F", "B_Heli_Light_01_dynamicLoadout_F"],
		["B_Heli_Light_01_armed_F", "B_Heli_Light_01_dynamicLoadout_F"]
	];
	...
	_missionHintText = format ["A squadron of <t color='%3'>3 %1</t> has been spotted! Destroy them and recover their cargo!", _vehicleName, airborneMissionColor];
