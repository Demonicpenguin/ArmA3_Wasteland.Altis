...
_setupObjects =
{
	...
	_missionHintText = format ["Attention, ladies and gents! <t color='%3'>Two %1</t> have been spotted.<br/>Do not try to bring them down with improper equipment - otherwise you will die very soon.", _vehicleName, _vehicleName2, airborneMissionColor];
