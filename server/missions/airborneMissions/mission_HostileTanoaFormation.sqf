...
// ******************************************************************************************
//	@file Name: mission_HostileTanoaFormation.sqf
...
_setupObjects =
{
	...
	_missionHintText = format ["Two <t color='%3'>%1</t> are big, loud and in the sky! Take them down! And save their cargo!", _vehicleName, _vehicleName2, airborneMissionColor];
...
_successExec =
{
	...
	_successHintMessage = "Well done! Fishes belong to water, not the sky! Find the cargo near the last wreck!";
};
