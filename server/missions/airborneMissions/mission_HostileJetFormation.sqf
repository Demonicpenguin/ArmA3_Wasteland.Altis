...
_setupObjects =
{
	...
	_missionHintText = format ["2 <t color='%3'>%1</t> have been spotted. Rumors say, they carry fucking weapon crates - tourists in disguise!", _vehicleName, _vehicleName2, airborneMissionColor];
