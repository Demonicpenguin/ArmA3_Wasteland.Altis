...
private ["_planeChoices", "_convoyVeh", "_veh1", "_veh2", "_createVehicle", "_vehicles", "_leader", "_speedMode", "_waypoint", "_vehicleName", "_vehicleName2", "_numWaypoints", "_cash", "_boxes1", "_currBox1", "_boxes2", "_currBox2", "_box1", "_box2", "_smokemarker"];

_setupVars =
{
	_missionType = "Air Superiority Sortie";
	_locationsArray = nil;
};
...
_setupObjects =
{
	...
	_planeChoices =
	[
		[["O_Plane_Fighter_02_F", "shikraAA"], ["O_Plane_Fighter_02_F", "shikraAA"]],
		[["B_Plane_Fighter_01_F", "blackwaspAA"], ["B_Plane_Fighter_01_F", "blackwaspAA"]],
		[["O_Plane_Fighter_02_F", "shikraAA"], ["O_Plane_Fighter_02_F", "shikraAA"]]
	];
	...
	_missionHintText = format ["What the fuck!? 2 <t color='%3'>%1</t> have been spotted.<br/>Two fighers have been scrambled. Watch your Six!!", _vehicleName, _vehicleName2, airborneMissionColor];
