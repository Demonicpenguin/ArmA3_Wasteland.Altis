...
_setupObjects =
{
	...
	_missionHintText = format ["<br/>Terrorists has taken over <br/><t size='1.25' color='%1'>%2</t>.<br/><t color='%1'>%3 of these highly trained men</t> are lurking in the area. Eliminate them all, claim their cash and drugs stash and clear the area!", occupationMissionColor, _townName, _nbUnits];
};
