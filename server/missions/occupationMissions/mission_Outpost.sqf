...
_setupObjects =
{
	...
	_missionHintText = format ["<br/>A <t color='%1'>base of paramilitary units</t> containing weapon crates has been spotted near the marker. <br/> Good luck for it! Be aware of the static MGs!", occupationMissionColor]
};
