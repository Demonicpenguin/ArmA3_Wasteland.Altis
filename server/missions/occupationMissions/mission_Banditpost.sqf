...
_setupObjects =
{
	...
	_missionHintText = format ["<br/>A <t color='%1'>group of bandits</t> claim the marked area to their own. <br/> Go there, eliminate these wankers and destroy the camp!", occupationMissionColor]
};
