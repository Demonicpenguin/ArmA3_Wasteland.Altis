...
_setupObjects =
{
	...
	_missionHintText = format ["<br/>A <t color='%1'>Hunter</t> has been immobilized in or near <t color='%1'>%2</t>! <t color='%1'>%3 armed units</t> just arrived there to save the vehicle. <br/>Kill them all, save the cargo and try to get the Hunter!", occupationMissionColor, _townName, _nbUnits];
};
...
_successExec =
{
	...
	_successHintMessage = format ["Good work!<br/><br/><t color='%1'>%2</t> has been cleared!<br/>What's up with the Hunter ..?", occupationMissionColor, _townName];
