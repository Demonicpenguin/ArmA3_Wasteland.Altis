...
_setupVars =
{
	_missionType = "Deep OffShore Sunken Treasure";
	_locationsArray = SunkenMissionMarkers2;
};
...
_setupObjects =
{
	...
	_missionPicture = "media\divers.jpg";	
	//_missionPicture = getText (configFile >> "CfgVehicles" >> _vehicleClass >> "picture");
	_missionHintText = format ["A treasure containing <t color='%1'>$2,000000</t> and weapons is being recovered.<br/>If you want to capture it, you will need diving gear and an underwater weapon.", marineMissionColor];
};
