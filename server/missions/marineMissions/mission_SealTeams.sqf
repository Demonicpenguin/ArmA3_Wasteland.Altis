...
_setupObjects =
{
	...
	[
		...
		[_veh2, _starts select 2, _startdirs select 2] call _createVehicle
	];
	...
	_missionHintText = format ["A Seal Team with two <t color='%3'>%1</t> have been spotted patrolling the coasts.<br/>Intercept them and recover their cargo!", _vehicleName, marineMissionColor];
