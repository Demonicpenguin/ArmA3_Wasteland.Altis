...
private ["_group", "_pos", "_nbUnits", "_unitTypes", "_uPos", "_unit", "_nStatic"];
...
{
	_uPos = [10743,6651.71,0] vectorAdd ([[random _radius, 0, 0], random 360] call BIS_fnc_rotateVector2D);
...
[_group, _pos, "LandVehicle"] call defendAlcatraz;
