...
private ["_group", "_pos", "_depth", "_leader", "_man2", "_man3", "_man4", "_man5", "_man6", "_man7", "_man8", "_man9", "_man10", "_man11","_man12", "_man13", "_man14", "_man15", "_man16"];
...
// Rifleman
_leader = _group createUnit ["C_man_polo_1_F", [_pos select 0, _pos select 1, -35], [], 1, "Form"];
...
// Rifleman
_man2 = _group createUnit ["C_man_polo_2_F", [_pos select 0, _pos select 1, -35], [], 1, "Form"];
...
// Rifleman
_man3 = _group createUnit ["C_man_polo_3_F", [_pos select 0, _pos select 1, -35], [], 1, "Form"];
_man3 swimInDepth -80;
...
// Rifleman
_man4 = _group createUnit ["C_man_polo_4_F", [_pos select 0, _pos select 1, -35], [], 1, "Form"];
...
// Rifleman
_man5 = _group createUnit ["C_man_polo_5_F", [_pos select 0, _pos select 1, -35], [], 1, "Form"];
...
// Rifleman
_man6 = _group createUnit ["C_man_polo_4_F", [_pos select 0, _pos select 1, -35], [], 1, "Form"];
...
// Rifleman
_man7 = _group createUnit ["C_man_polo_4_F", [_pos select 0, _pos select 1, -35], [], 1, "Form"];
...
// Rifleman
_man8 = _group createUnit ["C_man_polo_4_F", [_pos select 0, _pos select 1, -35], [], 1, "Form"];
...
// Rifleman
_man9 = _group createUnit ["C_man_polo_4_F", [_pos select 0, _pos select 1, -35], [], 1, "Form"];
...
// Rifleman
_man10 = _group createUnit ["C_man_polo_4_F", [_pos select 0, _pos select 1, -35], [], 1, "Form"];
...
// Rifleman
_man11 = _group createUnit ["C_man_polo_4_F", [_pos select 0, _pos select 1, -35], [], 1, "Form"];
...
// Rifleman
_man12 = _group createUnit ["C_man_polo_4_F", [_pos select 0, _pos select 1, -35], [], 1, "Form"];
...
// Rifleman
_man13= _group createUnit ["C_man_polo_4_F", [_pos select 0, _pos select 1, -35], [], 1, "Form"];
...
// Rifleman
_man14= _group createUnit ["C_man_polo_4_F", [_pos select 0, _pos select 1, -35], [], 1, "Form"];
...
// Rifleman
_man15= _group createUnit ["C_man_polo_4_F", [_pos select 0, _pos select 1, -35], [], 1, "Form"];
...
// Rifleman
_man16= _group createUnit ["C_man_polo_4_F", [_pos select 0, _pos select 1, -35], [], 1, "Form"];
