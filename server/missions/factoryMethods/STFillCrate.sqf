...
********************************************************************************************
* @file Name: STFillCrate.sqf
* @author: The Scotsman
*
* Loads Crates With Stuff
* Arguments: [ _box ]:
*
*/
...
if( random 100 <= 5 ) then { _primaryWeapons pushBack (selectRandom STSpecialWeapons); };
...
if( _box isKindOf "I_CargoNet_01_ammo_F" || _box isKindOf "O_CargoNet_01_ammo_F" ) then {

	0 = [_box] execVM "server\missions\factoryMethods\STCreateConvenienceKit.sqf";
