...
switch (_boxType) do
{
	...
	case "mission_HVSniper":
	{
		...
		[
			// Item type, Item class(es), # of items, # of magazines per weapon
			["wep", ["srifle_LRR_camo_F", "srifle_LRR_tna_F", "srifle_EBR_F", "srifle_DMR_01_F"], RANDOM_BETWEEN(1,2), RANDOM_BETWEEN(2,4)],
			["wep", ["srifle_GM6_F", "srifle_GM6_camo_F", "srifle_GM6_ghex_F"], RANDOM_BETWEEN(1,2), RANDOM_BETWEEN(2,4)],
	...
	case "mission_Uniform":
	{
		...
		[
			...
			["itm", ["U_B_Wetsuit", "U_O_Wetsuit", "U_I_Wetsuit"], RANDOM_BETWEEN(1,3)],
			["itm", ["U_B_FullGhillie_sard", "U_O_FullGhillie_sard", "U_I_FullGhillie_sard"], RANDOM_BETWEEN(1,3)],
			["itm", ["U_BG_Guerilla3_1", "U_OG_Guerilla3_1", "U_IG_Guerilla3_1"], RANDOM_BETWEEN(1,3)],
			["bac", ["B_Carryall_mcamo", "B_Kitbag_mcamo", "B_Bergen_hex_F"], RANDOM_BETWEEN(1,2)],
	...
	case "mission_UAV":
	{
		...
		[
			...
			["itm", "O_UavTerminal", 1],
			["itm", "I_UavTerminal", 1],
			["bac", ["I_UAV_01_backpack_F", "C_IDAP_UAV_06_antimine_backpack_F"], RANDOM_BETWEEN(1,1)]
		];
	};	
	...
	case "mission_HVLaunchers":
	{
		...
		[
			// Item type, Item class(es), # of items, # of magazines per weapon
			["wep", ["launch_RPG32_F", "launch_NLAW_F", "launch_I_Titan_short_F"], RANDOM_BETWEEN(2,3), RANDOM_BETWEEN(1,2)],
			["wep", "launch_I_Titan_F", RANDOM_BETWEEN(1,2), RANDOM_BETWEEN(1,2)],
			["mag", ["SmokeShellRed", "SmokeShellOrange", "SmokeShellGreen", "SmokeShellBlue", "SmokeShellPurple"], RANDOM_BETWEEN(1,3)],
			["mag", ["SLAMDirectionalMine_Wire_Mag", "ATMine_Range_Mag", "DemoCharge_Remote_Mag", "SatchelCharge_Remote_Mag"], RANDOM_BETWEEN(2,3)],
			["mag", "Titan_AP", RANDOM_BETWEEN(1,2)]
		];
	};
	...
	case "mission_jackpot":
    	{
    		...
    		[
    			...
    			["wep", [["srifle_DMR_02_F", "srifle_DMR_02_camo_F"], // MAR-10
    			         ["srifle_DMR_03_F", "srifle_DMR_03_multicam_F"], // Mk-I
    			         ["srifle_DMR_05_blk_F", "srifle_DMR_05_hex_F"]] /* Mk14 */, RANDOM_BETWEEN(0,2), RANDOM_BETWEEN(3,8)],
    			["wep", ["srifle_EBR_F", "srifle_DMR_01_F"], RANDOM_BETWEEN(0,3), RANDOM_BETWEEN(3,8)],
	...
	case "mission_ScientistSpecial":
    	{
    		_boxItems =
    		[
    			// Item type, Item class(es), # of items, # of magazines per weapon
    			//["itm", "NVGoggles", 5],
				["bac", ["C_IDAP_UAV_06_antimine_backpack_F", "I_UAV_01_backpack_F", "B_UAV_01_backpack_F", "O_UAV_01_backpack_F"], RANDOM_BETWEEN(1,1)],
				["itm", "B_UavTerminal", 1],
				["itm", "O_UavTerminal", 1],
				["itm", "I_UavTerminal", 1],				
    			["itm", "H_HelmetO_ViperSP_hex_F", 3]
    		];
    	};
