...
[] spawn
{
	...
	while {true} do
	{
		...
		else
		{
			...
			_earplugs = "addons\statusbar\icons\earplugs_on.paa";
			if (soundVolume > 0.5) then {
				_earplugs = "addons\statusbar\icons\earplugs_off.paa";
			};				
			...
			_time = (round(360-(serverTime)/60));  //edit the '720' value (60*12=720) to change the countdown timer if your server restarts are shorter or longer than 4 hour intervals
			...
			["
				...
				<t shadow='1' shadowColor='#000000' color='%9' ><img size='1.0' shadowColor='#000000' image='%9' color='%9'/></t>
