...
#define HVT_AMOUNT 550000  // how much a player needs to be carrying to become a HVT
...
while {true} do
{
	...
	if (_isHvT && !((getMarkerPos _markerName) isEqualTo [0,0,0]) && !(isNull findDisplay 49)) then
	{
		...
		#endif
		#ifdef __PUNISH_HVT_LOGOUT__
			_text = "\n\n\n\n\n\n!!! WARNING !!!\nAborting out as a High-Value-Target is not allowed! - Please drop or deposit Money at ATM or Safe";
