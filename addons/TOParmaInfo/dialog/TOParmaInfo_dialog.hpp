...
class TOParmaInfoD
{
	...
	class controls
	{
		...
		class TAGeneralInfoBackground: RscText
		{
			...
			type = CT_STRUCTURED_TEXT;
			size = 0.030;
			text = "Website: www.rawgaming.eu/ Forums: www.rawgaming.forum TeamSpeak: rawus.teamspeak3.com Manuals: Ship_Instruction_Manual";
			x = "0 * (((safezoneW / safezoneH) min 1.2) / 40)";
		...
		{
			idc = -1;
			action = "closeDialog 0;[] execVM 'addons\scripts\intro.sqf'";
