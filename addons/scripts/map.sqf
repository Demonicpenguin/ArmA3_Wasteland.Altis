...
diag_log "[MAP CLEANUP] Hight -> SCRIPT LOADED";
...
private _ttdBodies = M* 5*60; // seconds to delete dead bodies (0 means don't delete)
private _ttdVehiclesDead = M* 5*60; // seconds to delete dead vehicles (0 means don't delete)
private _ttdVehiclesImmobile = M* 15*60; // seconds to delete immobile vehicles (0 means don't delete)
