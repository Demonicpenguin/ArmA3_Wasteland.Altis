...
_BLUveh = ["B_Boat_Transport_01_F","B_SDV_01_F","B_Lifeboat","B_Boat_Armed_01_minigun_F","HAFM_ABurke","HAFM_GunBoat_BLU"];	//"HAFM_Virginia","HAFM_214"
_OPFveh = ["O_Boat_Transport_01_F","O_Boat_Armed_01_hmg_F","O_SDV_01_F","O_Lifeboat","HAFM_Admiral","HAFM_052C","HAFM_BUYAN"]; //"HAFM_Yasen"
_INDveh = ["I_Boat_Transport_01_F","I_Boat_Armed_01_minigun_F","I_SDV_01_F","HAFM_Russen_IND","HAFM_CB90","HAFM_GunBoat","HAFM_GunBoat"];
...
if(_vehSpots > 0)then{
	...
	for "_i" from 1 to _vehSpots do {
		...
		_man addEventHandler ["Killed", server_playerDied];
		sleep 0.3 ;
	};
};
