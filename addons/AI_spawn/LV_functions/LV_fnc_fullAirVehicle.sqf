...
_BLUveh = ["B_Heli_Light_01_armed_F","B_Heli_Attack_01_F","B_Plane_CAS_01_dynamicLoadout_F"];
_OPFveh = ["O_Heli_Attack_02_F","O_Heli_Attack_02_black_F","O_Heli_Light_02_F"];
_INDveh = ["I_Plane_Fighter_03_CAS_F","I_Plane_Fighter_03_AA_F","I_Plane_Fighter_03_CAS_F"];
