...
_isBox = { _this isKindOf "ReammoBox_F" || _this isKindOf "I_CargoNet_01_ammo_F" || _this isKindOf "O_CargoNet_01_ammo_F" || _this isKindOf "rhsusf_mags_crate" || _this isKindOf "Land_Cargo20_military_green_F" };
